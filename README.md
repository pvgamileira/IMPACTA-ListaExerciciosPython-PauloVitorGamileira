# Listas de Exercícios Python - Faculdade Impacta
...
Para testar os ficheiros e executar os exercícios na sua máquina local, siga os passos abaixo:

1. **Pré-requisitos:** Certifique-se de que tem a linguagem [Python](https://www.python.org/) (versão 3.x) instalada no seu computador.
